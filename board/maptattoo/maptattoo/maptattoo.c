...
static void setup_debug_led(void) {
	...
	/* Set as output */
	gpio_request(IMX_GPIO_NR(2, 4), "EPDC VCOM1");
...
static iomux_v3_cfg_t const usdhc2_pads[] = {
	...
	/*CD pin*/
	MX6_PAD_SD2_DATA7__GPIO5_IO00 | MUX_PAD_CTRL(NO_PAD_CTRL),
};
...
static iomux_v3_cfg_t const elan_pads[] = {
	MX6_PAD_EPDC_PWR_CTRL2__GPIO2_IO09 | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_EPDC_PWR_CTRL3__GPIO2_IO10 | MUX_PAD_CTRL(ELAN_INTR_PAD_CTRL),
	MX6_PAD_KEY_COL6__GPIO4_IO04 | MUX_PAD_CTRL(EPDC_PAD_CTRL),
};
...
//OTG2 is used in Gamma should change in Delta
static iomux_v3_cfg_t const usb_otg_pads[] = {
	/* OTG1 */
	MX6_PAD_KEY_COL4__USB_OTG1_PWR | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_EPDC_PWR_COM__USB_OTG1_ID | MUX_PAD_CTRL(OTGID_PAD_CTRL),
	/* OTG2 */
...
iomux_v3_cfg_t const mxc_kpd_pads[] = {
	(MX6_PAD_KEY_COL0__KEY_COL_0 | MUX_PAD_CTRL(NO_PAD_CTRL)),
	(MX6_PAD_KEY_COL1__KEY_COL_1 | MUX_PAD_CTRL(NO_PAD_CTRL)),
	(MX6_PAD_KEY_COL2__KEY_COL_2 | MUX_PAD_CTRL(NO_PAD_CTRL)),
	(MX6_PAD_KEY_COL3__KEY_COL_3 | MUX_PAD_CTRL(NO_PAD_CTRL)),

	(MX6_PAD_KEY_ROW0__KEY_ROW_0 | MUX_PAD_CTRL(MX6SLL_KEYPAD_CTRL)),
	(MX6_PAD_KEY_ROW1__KEY_ROW_1 | MUX_PAD_CTRL(MX6SLL_KEYPAD_CTRL)),
	(MX6_PAD_KEY_ROW2__KEY_ROW_2 | MUX_PAD_CTRL(MX6SLL_KEYPAD_CTRL)),
	(MX6_PAD_KEY_ROW3__KEY_ROW_3 | MUX_PAD_CTRL(MX6SLL_KEYPAD_CTRL)),
};
...
static void spl_dram_init(void)
{
	...
	mx6sll_dram_iocfg(32, &mx6_ddr_ioregs, &mx6_grp_ioregs);
